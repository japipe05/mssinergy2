  ...
  return (
    <>
            ...
            <div className="flex items-center justify-between ">
              ...
              <div className="flex items-center md:gap-2 gap-1">
                <div className="btn-circle-hover cursor-pointer sm:h-10 sm:w-10">
                  <IconPhone className="sm:h-10 h-5 " />
                </div>
                <div className="btn-circle-hover cursor-pointer sm:h-10 sm:w-10">
                  <IconVideo className="sm:h-10 h-5 " />
                </div>
                <div
                  className="btn-circle-hover cursor-pointer sm:h-10 sm:w-10 xl:flex hidden"
                  onClick={handleButtonClick}
                >
                  <IconDotsVertical className="sm:h-10 h-5 " />
                </div>
      ...
      <div className="flex max-h-[800px] h-[650px] ">
        ...
        >
          <div className="lg:border-e border-ld h-full py-5 px-5">
                      ...
                      {selectedChat.id === msg.senderId ? (
                        <div className="flex gap-3">
                          ...
                          {msg.type === "text" ? (
                            <div>
                              ...
                              <div className="p-2 bg-lightbg font-medium dark:bg-darkbody rounded-md">
                                {msg.msg}
                              </div>
                            </div>
                          ) : null}
                        ...
                        <div className="flex  justify-end w-full">
                          <div>
                            ...
                            {msg.type === "text" ? (
                              <div className="p-2 bg-lightinfo dark:bg-lightinfo rounded-md font-medium">
                                {msg.msg}
                              </div>
                            ) : null}
                            {msg.type === "image" ? (
